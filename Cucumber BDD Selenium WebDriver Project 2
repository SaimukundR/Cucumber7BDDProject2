...
📦Project Root
 ...
 ┃ ┃ ┣ 📂java
 ┃ ┃ ┃ ┣ 📂PageObjects
 ┃ ┃ ┃ ┃ ┣ 📜BasePage.java         // Parent class for common actions
 ┃ ┃ ┃ ┃ ┣ 📜LoginPage.java        // Page Object for login functionality
 ┃ ┃ ┃ ┣ 📂utils
 ┃ ┃ ┃ ┃ ┣ 📜MainDriver.java       // WebDriver setup and utility methods
 ┃ ┃ ┣ 📂resources
 ┃ ┃ ┃ ┣ 📜OR.properties           // Object Repository (Element locators)
 ┃ ┃ ┃ ┣ 📜config.properties       // Configurations (Browser, URL, Waits)
 ┃ 
 ┣ 📂test
 ┃ ┣ 📂java
 ┃ ┃ ┣ 📂stepDefinitions
 ┃ ┃ ┃ ┣ 📜LoginPageStepDef.java   // Step definitions for login page feature
 ┃ ┃ ┣ 📂testRunners
 ┃ ┃ ┃ ┣ 📜TestRunner.java         // Cucumber TestNG runner
 ┃
 ┃ ┣ 📂resources
 ┃ ┃ ┣ 📂features
 ┃ ┃ ┃ ┣ 📜loginPage.feature       // Feature file for login scenario
 ┃ ┃ ┃ ┣ 📜<additional-features>.feature // Other feature files
 ┃ ┃ ┣ 📜cucumber.properties       // Cucumber configuration (optional)
 ┃
